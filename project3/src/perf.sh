#!/bin/bash
#SBATCH -o /nfsmnt/223040076/coursecode/project3/result/perf.txt
#SBATCH -p Project
#SBATCH -J Project3
#SBATCH --nodes=1
...
#   srun -n $num_cores --cpus-per-task 1 --mpi=pmi2 perf stat -e cpu-cycles,cache-misses,page-faults,branch-misses /nfsmnt/223040076/coursecode/project3/build/src/quicksort/quicksort_mpi 100000000
...
# do
#   echo "Number of cores: $num_cores"
#   srun -n $num_cores --cpus-per-task 1 --mpi=pmi2 perf stat -e cpu-cycles,cache-misses,page-faults,branch-misses /nfsmnt/223040076/coursecode/project3/build/src/bucketsort/bucketsort_mpi 100000000 1000000
...
do
  echo "Number of cores: $num_cores"
  srun -n $num_cores --cpus-per-task 1 --mpi=pmi2 perf stat -e cpu-cycles,cache-misses,page-faults,branch-misses /nfsmnt/223040076/coursecode/project3/build/src/odd-even-sort/odd-even-sort_mpi 200000
