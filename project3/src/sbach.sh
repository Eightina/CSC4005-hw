...
srun -n 1 --cpus-per-task 1 /nfsmnt/your/path/to/project3/build/src/quicksort/quicksort_sequential 1000
echo ""
# MPI
...
do
  ...
  srun -n $num_cores --cpus-per-task 1 --mpi=pmi2 /nfsmnt/your/path/to/project3/build/src/quicksort/quicksort_mpi 1000
done
echo ""
