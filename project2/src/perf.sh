...
# srun -n 4 --cpus-per-task 8 --mpi=pmi2 perf stat -e cpu-cycles,cache-misses,page-faults,branch-misses  ${CURRENT_DIR}/../build/src/mpi 8 ${CURRENT_DIR}/../matrices/matrix5.txt ${CURRENT_DIR}/../matrices/matrix6.txt ${CURRENT_DIR}/../build/result.txt
# srun -n 4 --cpus-per-task 8 --mpi=pmi2 perf stat -e cpu-cycles,cache-misses,page-faults,branch-misses  ${CURRENT_DIR}/../build/src/mpi 8 ${CURRENT_DIR}/../matrices/matrix7.txt ${CURRENT_DIR}/../matrices/matrix8.txt ${CURRENT_DIR}/../build/result.txt
# echo ""
